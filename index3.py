...
def publish_automated_post():
    ...
    promotional_footer = (
        ...
        "-------------------------------------\n"
        "🇱🇰 SWAP GATE TEAM\n"
        "🚨 USDT BUY & SELL - SRI LANKA ONLY 🇱🇰\n\n"
        "🔐 Secure & Reliable\n"
        "⚡ Fast Processing\n"
        "🏦 Local Bank Support\n"
        "💬 Dedicated Customer Support\n"
        "-------------------------------------\n"
        "🌍 WORLDWIDE NEWS ACCESS\n\n"
        "📰 Understand how major global news can impact the Forex & Crypto markets — clearly explained in your own language, based on the country you are in.\n\n"
        "📊 Stay updated with the latest Crypto & Market News through our website's News Operation section.\n\n"
        "🔗 WhatsApp:\n"
